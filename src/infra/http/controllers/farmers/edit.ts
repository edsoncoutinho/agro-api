import { EditFarmerUseCase } from "@/domain/use-cases/edit-farmer";
...
export async function edit(
  ...
  const editFarmerUseCase = new EditFarmerUseCase(farmersRepository);

  const result = await editFarmerUseCase.execute({
    farmerId,
    name,
    document,
    documentType,
